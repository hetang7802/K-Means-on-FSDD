...
def dir_to_spectrogram(audio_dir, spectrogram_dir, spectrogram_dimensions=(64, 64), noverlap=16, cmap='gray_r'):
    ...
    for file_name in file_names:
        ...
        spectrogram_path = spectrogram_dir + file_name.replace('.wav', '.png')
...
if __name__ == '__main__':
    audio_dir = "C:/8th Sem/Computing with signals/Project/recordings/"
    spectrogram_dir = "C:/8th Sem/Computing with signals/Project/spectrograms/"
